import React from 'react';
    ...
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="#" class="flex items-center">
                <img src="/docs/images/logo.svg" class="mr-3 h-8" alt="Cek Halal Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CekHalal.Online</span>
            </a>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul class="text-gray-100 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:underline">CekHalal.Online</a>
                    </li>
                    <li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2022 <a href="#" class="hover:underline">CekHalal.Online</a>. All Rights Reserved.
        </span>
